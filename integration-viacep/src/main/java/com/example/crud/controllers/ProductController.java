...
import com.example.crud.service.AddressFinder;
...
public class ProductController {
    ...
    @Autowired
    public ProductController(ProductRepository repository, AddressSearch addressSearch, AddressFinder addressFinder) {
    ...
    public ResponseEntity verifyAddress(@PathVariable String id, @PathVariable String cep){
        boolean resulted = addressFinder.findAddress(id, cep);
